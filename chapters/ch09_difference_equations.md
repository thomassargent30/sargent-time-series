...
1959). Generated by
[`code/ch09_fig1_stability_regions.py`](https://github.com/thomassargent30/sargent-time-series/blob/main/code/ch09_fig1_stability_regions.py).
```
...
[`code/ch09_fig2_samuelson_locus.py`](https://github.com/thomassargent30/sargent-time-series/blob/main/code/ch09_fig2_samuelson_locus.py).
```
...
[`code/ch09_fig3_realizations.py`](https://github.com/thomassargent30/sargent-time-series/blob/main/code/ch09_fig3_realizations.py).
```
...
$-\phi = 2$. Generated by
[`code/ch09_fig4_root_determination.py`](https://github.com/thomassargent30/sargent-time-series/blob/main/code/ch09_fig4_root_determination.py).
```
