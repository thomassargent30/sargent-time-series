...
- **adaptive expectations** — [Prediction Examples](15_prediction_examples.md); [Signal Extraction](19_signal_extraction.md); [Optimal Filtering](26_optimal_filtering.md)
- **adjustment cost of capital** — [Investment Under Uncertainty](ch14_investment_uncertainty.md)
- **aggregation over time** — [Aggregation over Time](34_aggregation.md); [Sims's Formula](34a_sims_expository_note.md)
- **annihilation operator** $[\,\cdot\,]_+$ — [Linear Prediction](14_linear_prediction.md); [Partial Fractions](18a_partial_fractions.md); [Geometric Leads](20_geometric_leads.md); [Optimal Filtering](26_optimal_filtering.md); [Granger Causality](27_granger_causality.md); [Exact Linear RE](36b_exact_linear_re.md)
...
- **Friedman, Milton** — [Prediction Examples](15_prediction_examples.md); [Signal Extraction](19_signal_extraction.md)
...
- **Kalman filter (recursive projection)** — [Ch. X](ch10_regressions.md); [Signal Extraction](19_signal_extraction.md)
...
- **optimal prediction (compact / state-space)** — [Optimal Prediction](25_optimal_prediction.md); [Chain Rule](21_chain_rule.md)
...
- **partial fractions** — [Ch. IX](ch09_difference_equations.md); [Partial Fractions](18a_partial_fractions.md); [Inverse z-Transform](05_inverse_z_transform.md)
...
- **prewhitening filter** — [Filtering & Projections](30_filtering_projections.md); [Orthogonality & Filtering](31_orthogonality_filtering.md)
...
- **transfer function** $h(e^{-i\omega})$ — [Filter Kit](10_filter_kit.md); [Cross Spectrum](07_cross_spectrum.md)
...
- **Wiener filter** — [Optimal Filtering](26_optimal_filtering.md); [Solutions](38_exercise_solutions.md)
