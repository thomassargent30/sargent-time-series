...
[`code/ch33a_fig_habit.py`](https://github.com/maxmaxmaxmaxmaxmax373/sargent-time-series/blob/main/code/ch33a_fig_habit.py).
```
...
[`code/ch33a_fig_shortar.py`](https://github.com/maxmaxmaxmaxmaxmax373/sargent-time-series/blob/main/code/ch33a_fig_shortar.py).
```
